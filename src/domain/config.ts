...
export const copy = {
  es: {
    title: "Amiwi",
    subtitle: "companion de escritorio",
    focus: "Foco",
    work: "Trabajo",
    rest: "Descanso",
    settings: "Ajustes",
    ...
    onboardingQuick: "Onboarding 60s",
    onboardingTitle: "Configura Amiwi en 60 segundos",
    onboardingStep1: "Idioma",
    onboardingStep2: "Tu vibe",
    onboardingStep3: "Listo para empezar",
    onboardingHint1: "Elige cómo quieres ver la app.",
    onboardingHint2: "Selecciona una experiencia base.",
    onboardingHint3: "Puedes cambiar todo después en Ajustes.",
  ...
  en: {
    ...
    onboardingQuick: "60s onboarding",
    onboardingTitle: "Set up Amiwi in 60 seconds",
    onboardingStep1: "Language",
    onboardingStep2: "Your vibe",
    onboardingStep3: "Ready to start",
    onboardingHint1: "Choose how the app should speak to you.",
    onboardingHint2: "Pick a base experience profile.",
    onboardingHint3: "You can tweak everything later in Settings.",
    onboardingBack: "Back",
    onboardingNext: "Next",
